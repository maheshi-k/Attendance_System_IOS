...
import { getEmployee,addEmployee,getEmployeeById, updateEmployee, updateMyProfileController , updateEmployeeStatusByID , getEmployeeByStatusController, deleteEmployeeByID, getActiveEmployeeCountController, getMyProfileController, getAllSupervisorsController } from '../controllers/employee.controller.js';
...
router.get("/supervisors", authenticateToken, requirePermission("EMPLOYEE_VIEW"), getAllSupervisorsController);
